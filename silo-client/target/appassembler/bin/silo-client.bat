...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="silo-client" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" pt.tecnico.sauron.silo.client.SiloClientApp %CMD_LINE_ARGS%
